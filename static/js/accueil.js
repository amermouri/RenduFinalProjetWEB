window.onload=function(){
	...
	$.ajax({
		...
		success: function(data){
			login=data['username'];
			var Codehtml = ' <h3>Salut '+data['username']+' :) !</h3>';		
			console.log(Codehtml);
			var results= document.getElementById('UserLog');
	...
	$.ajax({
			...
			success: function(data){
				...
				mail = data['mail'];
				annee = data['annee'];
				console.log(data['nom'],data['prenom'],data['mail'],data['date_naissance'],data['annee']);
			},
			error:function(){
				Deconnexion();
			},
