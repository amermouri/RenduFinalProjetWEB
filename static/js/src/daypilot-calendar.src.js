        ...
        this._drawEvent = function(data) {
            ...
            if (!this.cssOnly) {
                ...
                if (data.data.backColor) {
                    inner.style.background = data.data.backColor;
                ...
                if (data.client.barVisible()) {
                    ...
                    if (data.data.barBackColor) {
                        bar.style.backgroundColor = data.data.barBackColor;
                    }
                    ...
                    if (data.data.barColor) {
                        barInner.style.backgroundColor = data.data.barColor;
                    }
